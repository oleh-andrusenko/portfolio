  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        custom={1}
        className='text-slate-600 text-center text-xl dark:text-white mb-4'
      >
      ...
      <motion.div
        variants={headingAnimation}
        custom={2}
        className='flex flex-col lg:flex-row lg:gap-12 w-full lg:h-72 rounded-xl shadow-lg bg-white dark:bg-slate-950 lg:my-8 lg:p-8 p-4'
      >
