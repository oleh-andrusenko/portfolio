...
const ProjectItem = forwardRef(
  ({ icon, title, description, link, git }, ref) => {
    return (
      <div
        ref={ref}
        className='  bg-slate-50 dark:bg-slate-700 lg:h-[300px] overflow-hidden flex items-center justify-between rounded-xl shadow-xl'
      >
